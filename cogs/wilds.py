...
_challenges = [Challenge("Of Body", {"strength": 1},
               ...
               Challenge("Of Mind", {"wit": 1},
                         ['What is the position of the Alpha?',
                          ...
                          'What is "a state of health when someone is >50% health."',
                          ...
                          'In an alamo, where should Alphas and Betas be located in terms of their team and ther enemies location?',
