...
emojis = _Struct(
    ...
    art=880531207912317009,
)

guilds = _Struct(tdt=164589623459184640)

messages = _Struct(
    CoC=563406038754394112,
    wolfpack=945717800788447282,
    trick_or_treat=1290378409826062398,
...
# roles
emoji2role = {
    emojis.tdt_bruh: roles.tdt_peeps,
    "⚔️": roles.d2pvp,
    "☠️": roles.d2pve,
